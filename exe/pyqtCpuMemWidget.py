...
class MonitorCPUMem(QWidget):
    ...
    def setupUi(self):
        ...
        # 设置label颜色及固定大小
        self.label.setStyleSheet("background-color:rgb(0, 255, 255);color:rgb(255, 0, 255);border:0px;border-radius:6px")
        self.label_2.setStyleSheet("background-color:rgb(255, 255, 0);color:rgb(255, 0, 255);border:0px;border-radius:6px")
