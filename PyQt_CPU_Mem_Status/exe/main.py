...
class MWidget(QWidget):
    ...
    def setupUi(self):
        ...
        # 移动窗口
        self.move(1300, 50)
        self.setStyleSheet("background-color:rgb(100, 255, 0);color:rgb(255, 0, 255);border:0px")
        ...
        # 设置label颜色及固定大小
        self.widget_1.setStyleSheet("background-color:rgb(100, 255, 0);color:rgb(255, 0, 255);border:0px")
        self.widget_2.setStyleSheet("background-color:rgb(100, 200, 0);color:rgb(255, 0, 255);border:0px")
...
def main():
    ...
    info["LSBackgroundOnly"] ="1"  # 隐藏mac的launcher/docker图标
